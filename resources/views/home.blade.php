...
<head>
    ...
    @include('partials.seo', [
        'title' => __('seo.titles.home', ['app' => config('app.name')]),
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
            ...
            @if (Route::has('login'))
                <nav class="flex items-center gap-2 sm:gap-3">
                    ...
                    @auth
                        <a href="{{ url('/dashboard') }}"inline-flex items-center px-4 py-1.5 rounded-lg bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 text-sm font-medium hover:bg-zinc-700 dark:hover:bg-white transition-colors
        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6">
            <div class="bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-700 shadow-sm overflow-hidden">
                ...
                <div class="p-6 sm:p-8">
                    <p class="text-xs font-medium text-zinc-400 dark:text-zinc-500 uppercase tracking-wider mb-3">{{ __('home.mock.long_label') }}</p>
                    <div class="flex items-center gap-3 p-3 rounded-lg bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 font-mono text-sm text-zinc-400 dark:text-zinc-500 overflow-hidden">
                        ...
                        <span class="truncate">{{ __('home.mock.example_url') }}</span>
                    </div>
                    ...
                    <p class="text-xs font-medium text-zinc-400 dark:text-zinc-500 uppercase tracking-wider mb-3">{{ __('home.mock.becomes') }}</p>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div class="p-6 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800">
                    ...
                    <h3 class="font-semibold text-zinc-900 dark:text-zinc-100 mb-1">{{ __('home.features.instant.title') }}</h3>
                    <p class="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">{{ __('home.features.instant.body') }}</p>
                </div>
                <div class="p-6 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800">
                    <div class="w-10 h-10 flex items-center justify-center rounded-lg bg-zinc-100 dark:bg-zinc-700 mb-4">
                    ...
                    <h3 class="font-semibold text-zinc-900 dark:text-zinc-100 mb-1">{{ __('home.features.qr.title') }}</h3>
                    <p class="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed mb-4">{{ __('home.features.qr.body') }}</p>
                </div>
                <div class="p-6 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800">
                    <div class="w-10 h-10 flex items-center justify-center rounded-lg bg-zinc-100 dark:bg-zinc-700 mb-4">
                        <svg class="w-5 h-5 text-zinc-600 dark:text-zinc-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 class="font-semibold text-zinc-900 dark:text-zinc-100 mb-1">{{ __('home.features.edit.title') }}</h3>
                    <p class="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">{{ __('home.features.edit.body') }}</p>
                </div>
            </div>
        </div>
    </section>
