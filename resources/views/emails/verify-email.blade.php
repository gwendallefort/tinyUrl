                                ...
                                <tr>
                                    <td style="padding-bottom:28px;">
                                        <p style="margin:0;font-size:15px;line-height:1.6;color:#52525b;">
                                            Hello,
                                            <br><br>
                                            Please verify your email address for your <strong>{{ config('app.name') }}</strong> account by clicking the button below.
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding-bottom:28px;">
                                        <p style="margin:0;font-size:15px;line-height:1.6;color:#52525b;">
                                            ...
                                            <br><br>
                                            If you didn’t ask to verify this address, you can safely ignore this message.
                                        </p>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td align="center" style="padding-top:24px;">
                            <p style="margin:0;font-size:12px;color:#a1a1aa;">
                                &copy; {{ date('Y') }} {{ config('app.name') }} &mdash; You're receiving this email because an account was created with this address.
                            </p>
                        </td>
                    </tr>
                </table>
