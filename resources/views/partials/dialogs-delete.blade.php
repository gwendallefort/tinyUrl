...
>
    ...
    <h3 class="text-base font-semibold text-zinc-900 dark:text-zinc-100 mb-2">{{ __('dashboard.delete.title') }}</h3>
    <p class="text-sm text-zinc-500 dark:text-zinc-400 mb-1">
        {{ __('dashboard.delete.intro') }}
    </p>
    <p id="delete-url-label" class="text-sm font-medium text-zinc-900 dark:text-zinc-100 mb-5 truncate"></p>
    <p class="text-sm text-zinc-500 dark:text-zinc-400 mb-5">{{ __('dashboard.delete.irreversible') }}</p>
